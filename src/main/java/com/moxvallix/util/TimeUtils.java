...
public class TimeUtils{
	 ...
	 *
	 * @throws com.moxvallix.exceptions.InvalidTimeFormatException If the time format given is invalid (contains time delimiters other than s, m, h, d or w) or is empty.
